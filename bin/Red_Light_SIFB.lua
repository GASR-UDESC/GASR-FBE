...
function Red_Light_SIFB:_get_active_color()
...
function Red_Light_SIFB._SpecialDraw(widget, cr, block)
...
function Red_Light_SIFB:exe( --[[include arguments]] )
	...
	LOG_FILE:write('Red_Light_SIFB--- '..self.label..' initialized\n')
	LOG_FILE:write('Red_Light_SIFB--- '..self.label..' execution completed\n')
...
Red_Light_SIFB.__index = Red_Light_SIFB

SIFB_Class.Red_Light_SIFB = Red_Light_SIFB
