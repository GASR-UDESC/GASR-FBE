...
function Blue_Light_SIFB:_get_active_color()
...
function Blue_Light_SIFB._SpecialDraw(widget, cr, block)
...
function Blue_Light_SIFB:exe( --[[include arguments]] )
	...
	LOG_FILE:write('Blue_Light_SIFB--- '..self.label..' initialized\n')
	LOG_FILE:write('Blue_Light_SIFB--- '..self.label..' execution completed\n')
...
Blue_Light_SIFB.__index = Blue_Light_SIFB

SIFB_Class.Blue_Light_SIFB = Blue_Light_SIFB
