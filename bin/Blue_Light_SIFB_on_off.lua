...
Blue_Light_SIFB_on_off = {
    event = 'output',
}

function Blue_Light_SIFB_on_off:_get_active_color()
...
function Blue_Light_SIFB_on_off._SpecialDraw(widget, cr, block)
...
function Blue_Light_SIFB_on_off:exe( event )
	...
	LOG_FILE:write('Blue_Light_SIFB_on_off--- '..self.label..' initialized\n')
	LOG_FILE:write('Blue_Light_SIFB_on_off--- '..self.label..' execution completed\n')
...
Blue_Light_SIFB_on_off.__index = Blue_Light_SIFB_on_off

SIFB_Class.Blue_Light_SIFB_on_off = Blue_Light_SIFB_on_off
