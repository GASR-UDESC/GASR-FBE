...
Red_Light_SIFB_on_off = {
    event = 'output',
}

function Red_Light_SIFB_on_off:_get_active_color()
...
function Red_Light_SIFB_on_off._SpecialDraw(widget, cr, block)
...
function Red_Light_SIFB_on_off:exe( event )
	...
	LOG_FILE:write('Red_Light_SIFB_on_off--- '..self.label..' initialized\n')
	LOG_FILE:write('Red_Light_SIFB_on_off--- '..self.label..' execution completed\n')
...
Red_Light_SIFB_on_off.__index = Red_Light_SIFB_on_off

SIFB_Class.Red_Light_SIFB_on_off = Red_Light_SIFB_on_off
