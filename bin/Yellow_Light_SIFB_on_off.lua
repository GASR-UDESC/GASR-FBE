...
Yellow_Light_SIFB_on_off = {
    event = 'output',
}

function Yellow_Light_SIFB_on_off:_get_active_color()
...
function Yellow_Light_SIFB_on_off._SpecialDraw(widget, cr, block)
...
function Yellow_Light_SIFB_on_off:exe( event )
	...
	LOG_FILE:write('Yellow_Light_SIFB_on_off--- '..self.label..' initialized\n')
	LOG_FILE:write('Yellow_Light_SIFB_on_off--- '..self.label..' execution completed\n')
...
Yellow_Light_SIFB_on_off.__index = Yellow_Light_SIFB_on_off

SIFB_Class.Yellow_Light_SIFB_on_off = Yellow_Light_SIFB_on_off
